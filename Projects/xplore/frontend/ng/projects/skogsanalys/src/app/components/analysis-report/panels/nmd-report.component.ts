...
@Component({
  ...
  selector: "xp-nmd-report",
  template: `
    <p>
      Anger trädslagsfördelning vilken kategoriserats till åtta olika skogstyper, samt marktyper i valt område.
      Användaren ska vara medveten om att redovisade siffror för skogstyperna är beräknade utifrån kartskiktet NMD
      (nationella marktäckedata) med 10 x 10 meters upplösning vilket kan ge lokala skillnader.
    </p>
    <br/>
    <div *ngIf="error">
...
export class NmdReportComponent {

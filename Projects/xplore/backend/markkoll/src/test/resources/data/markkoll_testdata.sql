INSERT INTO markkoll.projekt(id, namn, ort, projektTyp, beskrivning, skapad_av, skapad_datum, organisation)
...
FROM base b
   ,LATERAL (
    ...
    FROM dict
    ) AS sub(namn, ort, skapad_av, beskrivning, projektTyp, skapad_datum, organisation);
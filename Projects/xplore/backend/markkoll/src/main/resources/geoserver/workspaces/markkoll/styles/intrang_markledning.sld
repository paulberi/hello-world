  ...
  <sld:NamedLayer>
    ...
    <sld:UserStyle>
      ...
      <sld:FeatureTypeStyle>
        ...
        <sld:Rule>
          <sld:Title>Ny markledning</sld:Title>
          <ogc:Filter>
            <ogc:And>
        ...
        <sld:Rule>
          <sld:Title>Ny markledning - Servis</sld:Title>
          <ogc:Filter>
            <ogc:And>
              <ogc:PropertyIsEqualTo>
                <ogc:PropertyName>avtalstyp</ogc:PropertyName>
        ...
        <sld:Rule>
          <sld:Title>Markledning i enskilt vägområde</sld:Title>
          <ogc:Filter>
            <ogc:And>
              <ogc:PropertyIsEqualTo>
                <ogc:PropertyName>avtalstyp</ogc:PropertyName>
        ...
        <sld:Rule>
          <sld:Title>Markledning i statligt vägområde</sld:Title>
          <ogc:Filter>
            <ogc:And>
              <ogc:PropertyIsEqualTo>
                <ogc:PropertyName>avtalstyp</ogc:PropertyName>
        ...
        <sld:Rule>
          <sld:Title>Markledning som ska tas bort</sld:Title>
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>status</ogc:PropertyName>

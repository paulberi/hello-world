  ...
  <sld:NamedLayer>
    ...
    <sld:UserStyle>
      ...
      <sld:FeatureTypeStyle>
        ...
        <!-- Intrång -->
     	<sld:Rule>
        <sld:Title>Nytt kabelskåp</sld:Title>
        <ogc:Filter>
          <ogc:And>
        ...
        <!-- Servis -->
     	<sld:Rule>
        <sld:Title>Nytt kabelskåp - Servis</sld:Title>
        <ogc:Filter>
          <ogc:And>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>avtalstyp</ogc:PropertyName>
        ...
        <!-- Rev -->
     	<sld:Rule>
        <sld:Title>Nytt kabelskåp - Rev</sld:Title>
        <ogc:Filter>
          <ogc:And>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>avtalstyp</ogc:PropertyName>
        ...
        <!-- Raseras -->
        <sld:Rule>
          <sld:Title>Kabelskåp som ska tas bort</sld:Title>
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>status</ogc:PropertyName>

  ...
  <sld:NamedLayer>
    ...
    <sld:UserStyle>
      ...
      <sld:FeatureTypeStyle>
        ...
        <!-- Intrång -->
        <sld:Rule>
          <sld:Title>Ny nätstation</sld:Title>
          <ogc:Filter>
            <ogc:And>
        ...
        <!-- Servis -->
        <sld:Rule>
          <sld:Title>Ny nätstation - Servis</sld:Title>
          <ogc:Filter>
            <ogc:And>
              <ogc:PropertyIsEqualTo>
                <ogc:PropertyName>status</ogc:PropertyName>
        ...
        <!-- Rev -->
        <sld:Rule>
          <sld:Title>Ny nätstation - Rev</sld:Title>
          <ogc:Filter>
            <ogc:And>
              <ogc:PropertyIsEqualTo>
                <ogc:PropertyName>status</ogc:PropertyName>
        ...
        <!-- Raseras -->
        <sld:Rule>
          <sld:Title>Nätstation som ska tas bort</sld:Title>
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>status</ogc:PropertyName>
          ...
          <sld:PointSymbolizer>
            <sld:Graphic>
              ...
              <sld:Size>3.1</sld:Size>
              <sld:Rotation>1.0</sld:Rotation>
            </sld:Graphic>
          </sld:PointSymbolizer>
        </sld:Rule>
        <sld:Rule>

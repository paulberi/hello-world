  ...
  <sld:NamedLayer>
    ...
    <sld:UserStyle>
      ...
      <sld:FeatureTypeStyle>
        ...
        <sld:Rule>
          <sld:Title>Ny ledning</sld:Title>
          <ogc:Filter>
            <ogc:And>
        ...
        <sld:Rule>
          <sld:Title>Ny ledning - Servis</sld:Title>
          <ogc:Filter>
            <ogc:And>
              <ogc:PropertyIsEqualTo>
                <ogc:PropertyName>avtalstyp</ogc:PropertyName>
        ...
        <sld:Rule>
          <sld:Title>Ledning i enskilt vägområde</sld:Title>
          <ogc:Filter>
            <ogc:And>
              <ogc:PropertyIsEqualTo>
                <ogc:PropertyName>avtalstyp</ogc:PropertyName>
        ...
        <sld:Rule>
          <sld:Title>Ledning i statligt vägområde</sld:Title>
          <ogc:Filter>
            <ogc:And>
              <ogc:PropertyIsEqualTo>
                <ogc:PropertyName>avtalstyp</ogc:PropertyName>
        ...
        <sld:Rule>
          <sld:Title>Ledning som ska tas bort</sld:Title>
          <ogc:Filter>
            <ogc:And>
              <ogc:PropertyIsEqualTo>
                <ogc:PropertyName>avtalstyp</ogc:PropertyName>
          ...
          <sld:LineSymbolizer>
            <sld:Stroke>
              ...
              <sld:CssParameter name="stroke-dasharray">10.0 30.0</sld:CssParameter>
            </sld:Stroke>
          </sld:LineSymbolizer>
        </sld:Rule>
      </sld:FeatureTypeStyle>
